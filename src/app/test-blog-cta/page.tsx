...
const testBlogData = {
  ...
  // 호텔 sabre_id 필드들 (테스트용)
  s1_sabre_id: 1, // 첫 번째 섹션 다음에 호텔 카드 표시
  s2_sabre_id: null, // 두 번째 섹션에는 호텔 카드 없음
  s3_sabre_id: 2, // 세 번째 섹션 다음에 호텔 카드 표시
        ...
        <div className="mb-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• 첫 번째 섹션 다음에 호텔 카드 표시 (sabre_id: 1)</li>
              <li>• 두 번째 섹션에는 호텔 카드 없음 (sabre_id: null)</li>
              <li>• 세 번째 섹션 다음에 호텔 카드 표시 (sabre_id: 2)</li>
