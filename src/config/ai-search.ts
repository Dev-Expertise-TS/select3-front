...
2) 우리 투어비스 셀렉트 (Tourvis Select) 사이트에서 제공하는 호텔 중 키워드와 관련성이 높은 곳을 우선 추천하고, 각 추천에 대해 상위 브랜드/체인, 위치·특징, 추천 이유를 한 줄로 설명해. 적합한 후보가 부족하면 일반적인 상위 브랜드 대안을 제안해. 가능하면 대표 객실/스위트 팁을 한 줄 덧붙여라.
