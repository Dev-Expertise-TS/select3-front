...
export function HotelDetail({ 
  ...
  const gridImages = useMemo(() => {
    ...
    const filtered = validatedImages.filter((img: any) => {
    ...
    <TranslationErrorBoundary>
      ...
      <div key={`hotel-info-${hotel.sabre_id}`} suppressHydrationWarning>
        <HotelInfo
          hotel={hotel}
          images={gridImages}
          totalImagesCount={validatedImages.length}
              ...
              {/* 객실 정보 표시 */}
                ...
                <div className="text-center py-12">
                  ...
                  <div className="text-sm text-gray-500 space-y-1 mb-6">
                    <p>투숙일을 2박 연박 또는 다른 날짜로 검색을 해보세요.<br />
                    그래도 예약 가능한 객실이 없을 경우<br />
                    투어비스 셀렉트 호텔 전문 컨시어지에서<br />
                    객실 예약 및 추천 호텔에 대한 도움을 드리도록 하겠습니다.</p>
                              </div>
