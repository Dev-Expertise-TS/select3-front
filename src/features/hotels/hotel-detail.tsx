              ...
              {/* 객실 정보 표시 */}
                ...
                <div className="text-center py-12">
                  ...
                  <div className="text-sm text-gray-500 space-y-1 mb-6">
                    <p>투어비스 셀렉트 호텔 전문 컨시어지에게 문의하시면 <br />
                    요금 현황 및 대안 호텔에 대한 도움을 드리도록 하겠습니다.</p>
                              </div>
                  ...
                  <div className="flex justify-center">
                    <a
                      ...
                      className="inline-flex items-center justify-center px-6 py-3 font-medium rounded-lg transition-all duration-200 hover:scale-105"
