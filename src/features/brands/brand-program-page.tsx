...
async function getHotelChains() {
  ...
  if (true || error || !data) {
    ...
    const fallback: HotelChain[] = [
      ...
      { chain_id: 22, chain_name_en: 'Pan Pacific', chain_name_kr: '팬 퍼시픽', chain_slug: 'pan-pacific-orchard', logo_path: '/brand-image/pacific.avif' },
  ...
  const logoMap: Record<string, string> = {
    ...
    'pan-pacific-orchard': '/brand-image/pacific.avif',
